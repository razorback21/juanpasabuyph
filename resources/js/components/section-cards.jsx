...
export function SectionCards({
    ...
    return (
        <div
            ...
            <Card className="@container/card">
                <CardHeader className="relative">
                    <CardDescription>Purchased Cost</CardDescription>
                    <CardTitle className="@[250px]/card:text-3xl text-2xl font-semibold tabular-nums">
                        {currencyFormat(purchaseCost)}
                        {/*<span className="text-gray-400 text-sm font-thin">*/}
                        {/*   items*/}
                        {/*</span>*/}
                    </CardTitle>
                ...
                <CardFooter className="flex-col items-start gap-1 text-sm">
                    ...
                    <div className="text-muted-foreground">
                        Based on in-stock items only
                    </div>
                </CardFooter>
            </Card>
            <Card className="@container/card">
                <CardHeader className="relative">
                    <CardDescription>Total SRP from Purchased</CardDescription>
                    <CardTitle className="@[250px]/card:text-3xl text-2xl font-semibold tabular-nums">
                        {currencyFormat(totalSRPFromPurchased)}
                        {/*<span className="text-gray-400 text-sm font-thin">*/}
                        {/*        items*/}
                        {/*    </span>*/}
                    </CardTitle>
                ...
                <CardFooter className="flex-col items-start gap-1 text-sm">
                    ...
                    <div className="text-muted-foreground">
                        Based on SRP of in-stock items only
                    </div>
                </CardFooter>
            </Card>
            {/* <Card className="@container/card">
