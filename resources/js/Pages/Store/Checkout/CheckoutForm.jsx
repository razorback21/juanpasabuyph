...
export default function CheckOutForm() {
    ...
    const { flash, errors, checkoutDisabled } = props;
    ...
    if (checkoutDisabled) {
        return (
            <>
                ...
                <div className="mt-8">
                    <div className="flex items-center p-6 bg-red-50 rounded-lg border border-red-100">
                        <svg
                        ...
                        <p className="text-red-600 font-medium">
                            We are currently not accepting orders. Please try
                            again later.
                        </p>
                    </div>
                </div>
